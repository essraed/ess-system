...
const HomeOne = () => {
  ...
  return (
    <>
      ...
      {/* FAQ  */}
<section className="section faq-section bg-light-primary w-full">
  <div id="Services" className="homesection servicessection saa viewon w-full">
    <div className="custom-container px-4 md:px-8 lg:px-20">

      {/* Section Title */}
      <div className="section-heading mb-10" data-aos="fade-down">
        <h2 className="section-title text-3xl font-bold text-gray-800">
          {t("Frequently Asked Questions")}
        </h2>
      </div>

      {/* Accordion */}
      <Accordion className="w-full" style={{ backgroundColor: 'transparent', border: 'none' }}>
        {/* Item 1 */}
        <AccordionItem>
          <AccordionItemHeading>
            <AccordionItemButton
              style={{ backgroundColor: 'transparent', border: 'none' }}
              className="text-left text-lg font-semibold py-4 text-gray-900 hover:bg-blue-50"
            >
              {t("Karama Medical Fitness Center Medical Timing")}
            </AccordionItemButton>
          </AccordionItemHeading>
          <AccordionItemPanel className="pl-4 py-2 text-sm text-gray-700">
            <div className="space-y-4">
              <div>
                <h4 className="font-bold text-[#0f8992]">
                  {t("DHA Medical Fitness Center For Residents Visa New/Renewal")}
                </h4>
                <p>{t("Monday - Saturday 07:00 AM - 10:00 PM")}</p>
                <p>{t("Sunday 08:00 AM - 08:00 PM")}</p>
                <p className="text-red-600">
                  {t("Note: Saturday and Sunday after 01:00 PM only Visa Renewal is accepted (X-ray service not available after 01:00 PM)")}
                </p>
              </div>
              ...
              <div>
                <h4 className="font-bold text-[#0f8992]">{t("DED")}</h4>
                <p>{t("Monday - Saturday 08:00 AM - 08:00 PM")}</p>
                <p>{t("Sunday - Closed")}</p>
              </div>

              <div>
                <h4 className="font-bold text-[#0f8992]">{t("Amer")}</h4>
                <p>{t("Monday - Saturday 07:00 AM - 10:00 PM")}</p>
                <p>{t("Sunday - Closed")}</p>
              </div>

              <div>
                <h4 className="font-bold text-[#0f8992]">{t("Tas-Heel")}</h4>
                <p>{t("Monday - Saturday 08:00 AM - 08:00 PM")}</p>
                <p>{t("Sunday - Closed")}</p>
              </div>

              <div>
                <h4 className="font-bold text-[#0f8992]">{t("Taw-Jeeh")}</h4>
                <p>{t("Monday - Saturday 08:00 AM - 08:00 PM")}</p>
                <p>{t("Sunday - 09:00 AM - 05:00 PM")}</p>
              </div>
            </div>
          </AccordionItemPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          ...
          <AccordionItemPanel className="pl-4 py-2 text-sm text-gray-700">
            <p>{t("Dubai visa medical report can be tracked and downloaded from DHA mobile application.")}</p>
          </AccordionItemPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          <AccordionItemHeading>
            <AccordionItemButton
              ...
              className="text-left text-lg font-semibold py-4 text-gray-900 hover:bg-blue-50"
            >
              {t("What are the different types of Tourist or visit visas available")}
            </AccordionItemButton>
          </AccordionItemHeading>
          <AccordionItemPanel className="pl-4 py-2 text-sm text-gray-700">
            <p>{t("A tourist visa is available for 30 and 60 days and a sponsored family visit visa for 30 and 90 days.")}</p>
          </AccordionItemPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          <AccordionItemHeading>
            <AccordionItemButton
              ...
              className="text-left text-lg font-semibold py-4 text-gray-900 hover:bg-blue-50"
            >
              {t("Can I travel without applying for the visa stamping application")}
            </AccordionItemButton>
          </AccordionItemHeading>
          <AccordionItemPanel className="pl-4 py-2 text-sm text-gray-700">
            <p>{t("No, the applicant must complete the visa stamping application for he/she to travel.")}</p>
          </AccordionItemPanel>
        </AccordionItem>
      </Accordion>
    </div>
